    ...
    getLawyer(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const ratingData = req.params.getRatingData
                    ? yield rateMdl_1.default.aggregate([
                    ...
                    : null;
                return res.status(200).json({
                    lawyer: Object.assign(Object.assign({}, lawyer._doc), { ratingData: ratingData ? ratingData[0] : ratingData }),
                    ok: true
                });
            }
            catch (err) {
